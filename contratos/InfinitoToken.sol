    ...
    ReentrancyGuard
{
    ...
    function _increaseAllowance(
        ...
        return super._increaseAllowance(owner, spender, increment);
    }
    ...
    function _decreaseAllowance(
        ...
        return super._decreaseAllowance(owner, spender, decrement);
    }

    // ============================================
    // SOPORTE PARA ERC20Permit (gasless approvals)
    // ============================================
